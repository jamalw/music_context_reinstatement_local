...
void setup()
{
  ...
  //Ajouter une photo
  myImg = loadImage("/Users/jamalw/Desktop/turkey_chilling.jpg");
 
  //Charger la librairie minim
  minim = new Minim(this);
 
  //Charger la chanson
  song = minim.loadFile("/Users/jamalw/Desktop/PNI/music_event_structures/ProcessingCubes/data/U_Ya_Frenz.mp3");
